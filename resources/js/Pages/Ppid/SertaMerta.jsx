...
export const SertaMerta = ({ initialDocuments = [] }) => {
  ...
  return (
    <MainLayout>
      ...
      <PageHero
        ...
        subtitle="Daftar dokumen, regulasi, dan maklumat informasi terkait ancaman keselamatan publik dan kedaruratan"
        icon={AlertTriangle}
      ...
      <div className="w-full max-w-7xl mx-auto px-4 md:px-8 py-16 flex flex-col gap-8">
        <ScrollReveal direction="up" className="w-full">
          {/* Header Info Banner */}
          <div className="bg-amber-500/5 border border-amber-500/20 rounded-2xl p-6 flex flex-col md:flex-row md:items-center gap-6 shadow-sm mb-4">
            <div className="p-3 bg-amber-500/10 text-amber-600 dark:text-amber-400 rounded-xl w-fit">
              <AlertTriangle size={24} />
            </div>
            <div className="flex-1">
              <h3 className="text-base font-bold text-slate-900 dark:text-white">Informasi Serta Merta</h3>
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 leading-relaxed">
                Informasi yang dapat mengancam hajat hidup orang banyak dan ketertiban umum yang wajib diumumkan secara serta-merta tanpa penundaan sebagaimana diatur dalam Pasal 10 UU No. 14 Tahun 2008. Mencakup info kebencanaan, wabah penyakit, gangguan ketertiban, cuaca ekstrem, dan kedaruratan lainnya.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-4 bg-white dark:bg-slate-900/40 p-4 border border-slate-200/80 dark:border-slate-800 rounded-xl">
            <div className="relative flex-1 max-w-md">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 text-xs bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 text-slate-800 dark:text-slate-200"
              />
            </div>
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-slate-50 dark:bg-slate-900/60 border-b border-slate-200 dark:border-slate-800 text-[10px] font-black uppercase text-slate-500 tracking-wider">
                    ...
                    <th className="py-4 px-4 w-[60%]">Keterangan Informasi Serta Merta</th>
                      ...
                      <tr key={doc.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/10 transition-colors">
                        ...
                        <td className="py-4 px-4">
                          <div className="flex items-start gap-3">
                            <span className="p-1.5 bg-amber-500/10 text-amber-600 dark:text-amber-400 rounded-lg mt-0.5">
                              <FileText size={14} />
                            </span>
                        ...
                        <td className="py-4 px-4">
                          <div className="flex items-center justify-center gap-2">
                            <a
                              ...
                              className="p-1.5 bg-slate-100 hover:bg-amber-500/10 text-slate-600 dark:text-slate-400 hover:text-amber-600 dark:hover:text-amber-400 rounded-lg transition-colors"
                            ...
                            <a
                              href={getFileUrl(doc.fileUrl)}
                              download
                              className="p-1.5 bg-amber-500/10 hover:bg-amber-500 text-amber-600 dark:text-amber-400 hover:text-white rounded-lg transition-all"
                    ...
                    <tr>
                      <td colSpan={5} className="py-12 text-center text-slate-400">
                        <div className="flex flex-col items-center justify-center gap-2">
                          ...
                          <span className="text-[10px]">Belum ada informasi kedaruratan / serta merta yang diunggah saat ini.</span>
                        </div>
                      </td>
                    </tr>
                  )}
