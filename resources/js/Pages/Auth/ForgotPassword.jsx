...
import { Mail, ChevronLeft, AlertCircle, CheckCircle, KeyRound } from "lucide-react";
    ...
    try {
      ...
      if (res.ok && data.success) {
        ...
        const errMsg = data.errors 
          ...
          : (data.message || "Gagal memproses permintaan Anda.");
        setError(errMsg);
      }
    } catch (err) {
      console.error(err);
      ...
      <div className="w-full max-w-md bg-slate-950/60 backdrop-blur-xl border border-slate-800 p-8 md:p-10 rounded-3xl shadow-2xl relative z-10">
        ...
        {successMsg && (
          <div className="mb-6 p-4 bg-emerald-950/30 border border-emerald-500/35 rounded-2xl flex gap-3 text-emerald-300 items-start">
            ...
            <div className="flex flex-col gap-0.5">
              <span className="text-[10px] font-extrabold uppercase tracking-wider leading-none text-emerald-400">Email Dikirim</span>
        ...
        {error && (
          <div className="mb-6 p-4 bg-red-950/30 border border-red-500/35 rounded-2xl flex gap-3 text-red-300 items-start">
            ...
            <div className="flex flex-col gap-0.5">
              <span className="text-[10px] font-extrabold uppercase tracking-wider leading-none">Permintaan Gagal</span>
