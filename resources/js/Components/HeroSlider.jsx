    ...
    <section className="w-full relative overflow-hidden min-h-[85vh] flex items-center bg-slate-950">
      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto px-6 md:px-12 pt-36 pb-20 sm:pt-40 sm:pb-24 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
        ...
        <div className="lg:col-span-5 hidden lg:flex items-center justify-center relative min-h-[450px]">
          ...
          <div className="absolute w-[380px] h-[380px] rounded-full border border-emerald-500/10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none animate-[spin_60s_linear_infinite]" />
          <div className="absolute w-[440px] h-[440px] rounded-full border border-dashed border-teal-500/5 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none animate-[spin_80s_linear_infinite]" />
        </div>
      </div>
