...
4. Jika ditanya tentang sesuatu di luar konteks dinas, tolak dengan sopan dan arahkan mereka untuk menghubungi WhatsApp Humas Diskominfo.";
        ...
        if (str_contains($query, 'tte') || str_contains($query, 'sertifikat elektronik') || str_contains($query, 'tanda tangan')) {
            ...
            $reply = 'Kantor Dinas Komunikasi dan Informatika Kabupaten Banggai Kepulauan berlokasi di Kompleks Perkantoran Bukit Trikora, Salakan, Kecamatan Tinangkung, Sulawesi Tengah. Hubungi kami via email diskominfo@banggaikep.go.id atau WhatsApp Humas +62 822-9642-1245.';
