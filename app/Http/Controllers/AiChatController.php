    ...
    public function reply(Request $request)
    {
        ...
        if (!$apiKey) {
            return response()->json([
                'reply' => 'DEBUG ERROR: GEMINI_API_KEY is null or empty in config("services.gemini.key"). Please check your .env file and run "php artisan config:clear" inside the docker container on VPS.',
            ]);
        }
